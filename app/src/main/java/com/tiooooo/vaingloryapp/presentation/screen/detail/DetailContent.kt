...
import com.tiooooo.vaingloryapp.presentation.screen.detail.components.BottomSheetBackground
import com.tiooooo.vaingloryapp.presentation.screen.detail.components.BottomSheetContent
...
fun DetailContent(
    ...
    BottomSheetScaffold(modifier = modifier, sheetShape = RoundedCornerShape(
        ...
        BottomSheetContent(
            modifier = Modifier.background(Color(parseColor(darkVibrant))),
            hero = selectedHero,
        ...
        BottomSheetBackground(
            modifier = Modifier.fillMaxSize().background(Color(parseColor(darkVibrant))),
